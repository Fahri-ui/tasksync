...
export default function HomePage() { 
  ...
  return (
    <>
      <div
        className={`fixed left-1/2 top-0 z-50 w-full max-w-md -translate-x-1/2 transform transition-all duration-500 ease-out pointer-events-none ${
          isVisible
            ? "opacity-100 translate-y-[10vh] scale-100"
            : "-translate-y-full opacity-0 scale-95"
        }`}
        aria-live="polite"
      >
        <div className="rounded-lg bg-yellow-300 p-4 text-center text-sm font-semibold text-yellow-900 shadow-lg">
          Informasi: Antarmuka aplikasi ini tidak bersifat responsif. Disarankan menggunakan perangkat desktop untuk pengalaman terbaik.
        </div>
      </div>
